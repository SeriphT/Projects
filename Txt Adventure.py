...
character = Character(random.randrange(1, 10), random.randrange(1, 10), random.randrange(1, 10), random.randrange(1, 10), random.randrange(1, 10), random.randrange(1, 10))

r1 = Room('r1', 'You are in a small cave, with a barely audible sound of rushing water \ncoming from above. A exit of crumbled stones lies west, \nand to your south is a crack large enough to squeeze through.')
...
r6 = Room("You find yourself out on the surface. Looking back into the cave below, you see the monsters you fought (or didn't) climbing the rope after you. \nWith one final action, you drop the rope, as well as its occupants, back into the cave. You turn, walking away with a smile.", "you win!" )
...
def getCommand():
    print('What do you do? To access stats, type stat.')
    command = input()
    return command.lower().split()

def title():
   print("""
 .oooooo.                                                                                                .o88o.    ooooooooooooo           o8o                        oooo          
 d8P'  `Y8b                                                                                             888 `"    8'     888              `8            `"'                           `888          
888                      .oooo.   ooo    ooo  .ooooo.      .ooooo.       o888oo           888      oooo d8b    oooo   .oooo.        888   .oooo.o
888                   `P  )88b    `88.  .8'  d88' `88b        d88' `88b  888                 888       `888""8P       `888  `P  )88b   888     d88(  "8
888                   .oP"888     `88..8'   888ooo888     888   888  888                 888        888                   888   .oP"888   888     `"Y88b. 
`88b       ooo  d8(  888     `888'    888    .o             888   888  888                 888        888                   888  d8(  888   888      o.  )88b
 `Y8bood8P'  `Y888""8o  `8'     `Y8bod8P'       `Y8bod8P' o888o         o888o   d888b    o888o `Y888""   8o o888o 8""888P'

Text Adventure by Sabastian Taton and Logan Shelly

""")

def intro():
   print("Travelling through the woods one afternoon, you find yourself lost.")
   print("You travel further, before turning back to follow your path back to where you came.")
   print("As you walk, it starts to rain.")
   print("You continue to struggle through the downpour, soon falling through a hole in the ground, hitting your head as you fall.") 
   time.sleep(2)
